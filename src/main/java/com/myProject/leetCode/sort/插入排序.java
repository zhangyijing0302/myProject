...
public class 插入排序 {
    ...
    /**
     * 无序数列：1、5、4、2、6、3 <tr/>
     * 第一轮 ： <b>1、</b>5、4、2、6、3 <tr/>
     * 第二轮 ： <b>1、5、</b>4、2、6、3 <tr/>
     * 第三轮 ： <b>1、4、5、</b>2、6、3 <tr/>
     * 从这里开始2需要和5、4、交换位置，可以暂存2，4、5右移，空出来的第二个位置赋值2，以减少交换位置的次数<tr/>
     * 第四轮 ： <b>1、2、4、5、</b>6、3 <tr/>
     * 第五轮 ： <b>1、2、4、5、6、</b>3 <tr/>
